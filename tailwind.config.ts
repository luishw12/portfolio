  ...
  theme: {
    ...
    extend: {
      backgroundImage: {
        ...
        "hero-gradient":
          "linear-gradient(135deg, hsl(var(--background)) 0%, hsl(222 47% 8%) 50%, hsl(var(--background)) 100%)",
        "card-gradient":
      ...
      keyframes: {
        ...
        "pulse-button": {
          "0%, 100%": {
            boxShadow: "0 0 0 0 var(--pulse-color, hsl(var(--primary) / 0.5))",
          },
          "50%": {
            boxShadow:
              "0 0 0 var(--distance, 8px) var(--pulse-color, hsl(var(--primary) / 0))",
          },
        },
        "pulse-ripple": {
          "0%": {
            boxShadow: "0 0 0 0 var(--pulse-color, hsl(var(--primary) / 0.6))",
          },
          "100%": {
            boxShadow:
              "0 0 0 var(--distance, 8px) var(--pulse-color, hsl(var(--primary) / 0))",
