...
const defaultColors = ["#60a5fa", "#a855f7", "#ec4899"];
...
export default function Particles({
  ...
  const interactionRefProp = useRef(interactionRef);
  interactionRefProp.current = interactionRef;
  ...
  useEffect(() => {
    ...
    const getInteractionTarget = () =>
      interactionRefProp.current?.current ?? container;
